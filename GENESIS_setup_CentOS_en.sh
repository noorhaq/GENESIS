...
(
  ...
  chmod +x bioimage_CentOS.sh;
   sudo bash bioimage_CentOS.sh;
  sleep 2;;
...
cd $shell_CentOS;
  ...
  chmod +x motionCor2_CentOS.sh;
   sudo bash motionCor2_CentOS.sh;
...
cd $shell_CentOS;
  ...
  chmod +x auto_CentOS.sh;
   sudo bash auto_CentOS.sh;
  ...
  chmod +x virtual_stack_CentOS.sh;
   sudo bash virtual_stack_CentOS.sh;
  ...
  chmod +x CCP_EM_CentOS.sh;
   sudo bash CCP_EM_CentOS.sh;
  sleep 2;;
