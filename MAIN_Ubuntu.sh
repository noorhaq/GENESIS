...
selection=$(zenity --list --checklist \
	...
	FALSE 	1 	"bFactor"			"30.9"\
	FALSE 	2 	"cisTEM" 			"0.7"\
	FALSE 	3 	"diffMAP"			"30"\
	FALSE 	4 	"EDF"				"40"\
	FALSE 	5 	"ELEKTRONN"			"751.6"\
	FALSE 	6 	"findDQE"			"732.7"\
	FALSE 	7 	"frealign"			"0.3"\
	FALSE 	8 	"GCTF"				"5.1"\
	FALSE 	9 	"Relion"			"45.2"\
	FALSE 	10 	"Scipion"			"732.7"\
	FALSE 	11 	"Summovie"			"732.7"\
	FALSE 	12 	"Unblur"			"732.7"\
	FALSE 	13 	"Zorro"			"732.7")
echo $selection
...
(
   ...
   case $word in
	...
	chmod +x ELEKTRON_ubuntu.sh;
		sudo bash ELEKTRON_ubuntu.sh;
	sleep 2;;
	...
	chmod +x zorro_ubuntu.sh;
		sudo bash zorro_ubuntu.sh;
	sleep 2;;
